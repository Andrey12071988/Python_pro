01. Файл задания:
    DZ_06\modul\grig_data_01.py
    DZ_06\modul\start_01.py
...
модуль chess
3 и 4 задание не смог выполнить. Расчет позиции ферзей работает, 
но вставив в код, программа работает некорректно, пока не разобрался